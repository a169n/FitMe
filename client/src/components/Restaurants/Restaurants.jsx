...
export default function Restaurants() {
  ...
  return (
    <div className="foods-section global-padding">
      <div className="restaurants">
        <p className="food-section-header">Nearby Restaurants</p>
        <div className="foods-section-container">
          {firstEightRestaurants.map((restaurant) => (
            <div className="food-section-card" key={restaurant._id}>
              <img
      ...
      <div className="foods">
        <p className="food-section-header">Recommended Food Items</p>
        <div className="foods-section-container">
          {firstEightFoods.map((food) => (
            <div className="food-section-card" key={food._id}>
              <img
                className="restaurant-image"
                src={restaurant_image}
                alt="food-image"
